...
# VII) Data Analysis
# A)  Calculating 1. the number of restaurants for each restaurant type 
...
# B) A composite metric that considers both the rating and review count to assess 
...
# C) Creating a new column in dataset to store the assigned categories (A, B, C, D).
